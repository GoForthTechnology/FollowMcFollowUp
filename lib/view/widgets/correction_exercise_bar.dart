...
class CorrectionExerciseBar extends StatelessWidget {
  ...
  Row _vrdsRow(BuildContext context, ChartCorrectionViewModel model, ExerciseViewModel exerciseModel) {
  ...
  Widget build(BuildContext context) {
    return Consumer2<ChartCorrectionViewModel, ExerciseViewModel>(builder: (context, model, exerciseModel, child) => Column(children: [
      ...
      _stickerSelectionRow(model, exerciseModel),
      ...
      _vrdsRow(context, model, exerciseModel),
